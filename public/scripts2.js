...
// Update displayed currency values when the currency selector is changed
document.getElementById('currency').addEventListener('change', function () {
    updateCurrencyDisplay();
});

// Update the currency format for all displayed amounts
function updateCurrencyDisplay() {
    ...
    // Update the summary section with new currency format
    document.getElementById('total-income').innerText = formatCurrency(totalIncome);
    document.getElementById('total-expenses').innerText = formatCurrency(totalExpenses);
    document.getElementById('net-profit').innerText = formatCurrency(totalIncome - totalExpenses);
}
